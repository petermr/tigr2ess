...
AMI (picocli) offers possible corrections:
```
$ ami-search-new -p ocimum200 --diktionary country
Unknown options: --diktionary, country
Possible solutions: --dictionary, --dictionarySuffix, --dictionaryTop

Generic values (AMISearchTool)
================================
cProject must be existing directory or have directory parent: ocimum200(/Users/pm286/workspace/tigr2ess/ocimum200
************************
WARNING: CProject directory does not exist
************************
...
```
Command misses a `-` from `--dictionary` (easy to do). The system offers
alternatives.
```
$ ami-search-new -p ocimum200 -dictionary country
Unknown options: -dictionary, country
Possible solutions: --dictionary, --dictionarySuffix, --dictionaryTop
```


Command misses a `-` from `--doictionary` (easy to do). The system offers
alternatives.
```
$ ami-search-new -p ocimum200 -dictionary country
Unknown options: -dictionary, country
